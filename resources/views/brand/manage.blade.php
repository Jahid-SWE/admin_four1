                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-email-input4" class="col-sm-3 col-form-label">Brand Description</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" id="horizontal-email-input4"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label for="horizontal-email-input2" class="col-sm-3 col-form-label">Brand Image</label>
                                                <div class="col-sm-9">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All Brand Goes Here</h4>
